...
class Application {
    ...
    getRouter() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!this.router) {
                    this.router = new FramesBasedRouter_1.default({
                        app: this,
    ...
    getContext() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const ContextClass = require(path_1.join(this.appPath, "Context"));
    ...
    getConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const ConfigClass = require(path_1.join(this.appPath, "Config." + this.environment));
    ...
    getFrameControllerClass(frameName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return require(path_1.join(this.appPath, "frames", frameName, "controller")).default;
            }
            catch (e) {
    ...
    getFrameModules(frameName) {
        return __awaiter(this, void 0, void 0, function* () {
            const pack = yield this.configuration.modulePacker.addLocalPackage(path_1.join(this.appPath, "frames", frameName, "view.js"));
