...
function onHttpRequest(store, req, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield store.create("request", requestId, {
            type: "object",
...
function onRequest(store, requestId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sesionContext = yield sessions_1.getSessionContext(store, {
            type: "data",
            dataType: "request",
            id: requestId,
        }, sessionId);
        ...
        yield store.removeObject("http-request", requestId);
        yield store.removeObject("http-response", requestId);
    });
}
